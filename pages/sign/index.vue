            ...
            >
              ...
              >
                <el-input
                  ...
                  type="password"
                  placeholder="再次输入密码"
                  @keyup.enter.native="signUpRule(form)"
                />
              </el-form-item>
              <el-form-item>
                <el-button
...
export default {
  data() {
    ...
    const checkUserNameValid = (rule, value, callback) => {
      const params = {
        userName: value
      }
    ...
    return {
      Kurumi: { background: `url(${require('../../static/Kurumi.jpg')}) no-repeat`, backgroundSize: 'cover' },
      form: {
        userName: '',
        email: '',
        password: '',
